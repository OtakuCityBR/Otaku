/**
 * SISTEMA CARDCAPTOR SAKURA GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Cardcaptor Sakura
 */
class CardcaptorSakuraGallery {
    constructor() {
        // Lista de imagens do Cardcaptor Sakura
        this.images = [
            "https://i.ibb.co/hNGPPRt/c-1.jpg",
            "https://i.ibb.co/1Yj0bXBW/c-2.jpg",
            "https://i.ibb.co/3ygyYmxb/c-4.jpg",
            "https://i.ibb.co/SwrkXK9d/c-6.jpg",
            "https://i.ibb.co/qYV3mmnc/c-7.jpg",
            "https://i.ibb.co/Z6W71FK7/c-8.jpg",
            "https://i.ibb.co/ks09JdmR/c-9.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando CardcaptorSakuraGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando CardcaptorSakuraGallery...');
        ...
        console.log('CardcaptorSakuraGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Cardcaptor Sakura - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🌸 Olá! Quero esta placa do Cardcaptor Sakura (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO CARDCAPTOR SAKURA
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('cardcaptorsakura.html')) {
        console.log('Página de gallery Cardcaptor Sakura detectada - inicializando...');
        const cardcaptorSakuraGallery = new CardcaptorSakuraGallery();
    }
});
