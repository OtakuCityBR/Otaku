/**
 * SISTEMA TATE NO YUUSHA GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Tate no Yuusha
 */
class TateNoYushaGallery {
    constructor() {
        // Lista de imagens do Tate no Yuusha
        this.images = [
            "https://i.ibb.co/whVXGX6S/T-1.jpg",
            "https://i.ibb.co/1YYhnB63/T-2.jpg",
            "https://i.ibb.co/KpySc9Ty/T-3.jpg",
            "https://i.ibb.co/MxBRvqSx/T-4.jpg",
            "https://i.ibb.co/jvWTcWT5/T-5.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando TateNoYushaGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando TateNoYushaGallery...');
        ...
        console.log('TateNoYushaGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Tate no Yuusha - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🛡️ Olá! Quero esta placa do Tate no Yuusha (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO TATE NO YUUSHA
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('tatenoyusha.html')) {
        console.log('Página de gallery Tate no Yuusha detectada - inicializando...');
        const tatenoyushaGallery = new TateNoYushaGallery();
    }
});
