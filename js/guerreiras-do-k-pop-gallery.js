/**
 * SISTEMA GUERREIRAS DO K-POP GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para as Guerreiras do K-Pop
 */
class GuerreirasDoKPopGallery {
    constructor() {
        // Lista de imagens das Guerreiras do K-Pop
        this.images = [
            "https://i.ibb.co/qYLjDYqD/GK.jpg",
            "https://i.ibb.co/B2KrKvnN/GK1.jpg",
            "https://i.ibb.co/jF0S5mB/GK2.jpg",
            "https://i.ibb.co/JWyp3J7J/GK3.jpg",
            "https://i.ibb.co/TDgbfwNR/GK4.jpg",
            "https://i.ibb.co/WvVWmyFv/GK5.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando GuerreirasDoKPopGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando GuerreirasDoKPopGallery...');
        ...
        console.log('GuerreirasDoKPopGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Guerreiras do K-Pop - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `💃 Olá! Quero esta placa das Guerreiras do K-Pop (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DAS GUERREIRAS DO K-POP
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('guerreiras-do-k-pop.html')) {
        console.log('Página de gallery Guerreiras do K-Pop detectada - inicializando...');
        const guerreirasDoKPopGallery = new GuerreirasDoKPopGallery();
    }
});
