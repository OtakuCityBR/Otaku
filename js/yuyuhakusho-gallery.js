/**
 * SISTEMA YU YU HAKUSHO GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Yu Yu Hakusho
 */
class YuYuHakushoGallery {
    constructor() {
        // Lista de imagens do Yu Yu Hakusho
        this.images = [
            "https://i.ibb.co/S7s5ksjc/YuYu-1.jpg",
            "https://i.ibb.co/67Cr6J9N/YuYu-2.jpg",
            "https://i.ibb.co/spw9wFQ9/YuYu-3.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando YuYuHakushoGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando YuYuHakushoGallery...');
        ...
        console.log('YuYuHakushoGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Yu Yu Hakusho - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `👻 Olá! Quero esta placa do Yu Yu Hakusho (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO YU YU HAKUSHO
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('yuyuhakusho.html')) {
        console.log('Página de gallery Yu Yu Hakusho detectada - inicializando...');
        const yuYuHakushoGallery = new YuYuHakushoGallery();
    }
});
