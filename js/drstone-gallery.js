/**
 * SISTEMA DR. STONE GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Dr. Stone
 */
class DrStoneGallery {
    constructor() {
        // Lista de imagens do Dr. Stone
        this.images = [
            "https://i.ibb.co/mCPrRFXH/DS-1.jpg",
            "https://i.ibb.co/NnSM3k4w/DS-2.jpg",
            "https://i.ibb.co/V0RbjXgx/DS-3.jpg",
            "https://i.ibb.co/SwRddJzM/DS-4.jpg",
            "https://i.ibb.co/Jwr3jZ62/DS-5.jpg",
            "https://i.ibb.co/Z6GQHVzQ/DS-6.jpg",
            "https://i.ibb.co/dJJCjVrD/DS-7.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando DrStoneGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando DrStoneGallery...');
        ...
        console.log('DrStoneGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Dr. Stone - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🧪 Olá! Quero esta placa do Dr. Stone (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO DR. STONE
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('drstone.html')) {
        console.log('Página de gallery Dr. Stone detectada - inicializando...');
        const drstoneGallery = new DrStoneGallery();
    }
});
