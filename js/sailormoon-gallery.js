/**
 * SISTEMA SAILOR MOON GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Sailor Moon
 */
class SailorMoonGallery {
    constructor() {
        // Lista de imagens do Sailor Moon
        this.images = [
            "https://i.ibb.co/j1RVn6m/s-0.jpg",
            "https://i.ibb.co/BKGKHcGk/s-2.jpg",
            "https://i.ibb.co/DDfdDzZn/s-3.jpg",
            "https://i.ibb.co/N2tc1SpG/s-4.jpg",
            "https://i.ibb.co/TxkCvMLG/s-5.jpg",
            "https://i.ibb.co/n8PbYfmz/s-6.jpg",
            "https://i.ibb.co/ks5xFPQz/s-7.jpg",
            "https://i.ibb.co/vCLdGbWm/s-8.jpg",
            "https://i.ibb.co/bjsyPMpn/s-9.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando SailorMoonGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando SailorMoonGallery...');
        ...
        console.log('SailorMoonGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Sailor Moon - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🌙 Olá! Quero esta placa do Sailor Moon (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO SAILOR MOON
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('sailormoon.html')) {
        console.log('Página de gallery Sailor Moon detectada - inicializando...');
        const sailorMoonGallery = new SailorMoonGallery();
    }
});
