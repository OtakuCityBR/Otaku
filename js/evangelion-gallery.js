/**
 * SISTEMA EVANGELION GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Evangelion
 */
class EvangelionGallery {
    constructor() {
        // Lista de imagens do Evangelion
        this.images = [
            "https://i.ibb.co/hzbTxqz/E-1.jpg",
            "https://i.ibb.co/JWDqHfB2/E-2.jpg",
            "https://i.ibb.co/Y45hGGFp/E-3.jpg",
            "https://i.ibb.co/7tHt7QRy/E-4.jpg",
            "https://i.ibb.co/fd02L3NR/E-5.jpg",
            "https://i.ibb.co/8DM739mp/E-6.jpg",
            "https://i.ibb.co/WN0S1qdT/E-7.jpg",
            "https://i.ibb.co/chM9wYVr/E-8.jpg",
            "https://i.ibb.co/93ScpqJg/E-9.jpg",
            "https://i.ibb.co/N2yCN8ss/E-10.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando EvangelionGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando EvangelionGallery...');
        ...
        console.log('EvangelionGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Evangelion - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🤖 Olá! Quero esta placa do Evangelion (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO EVANGELION
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('evangelion.html')) {
        console.log('Página de gallery Evangelion detectada - inicializando...');
        const evangelionGallery = new EvangelionGallery();
    }
});
