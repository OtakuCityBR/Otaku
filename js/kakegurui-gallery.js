/**
 * SISTEMA KAKEGURUI GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Kakegurui
 */
class KakeguruiGallery {
    constructor() {
        // Lista de imagens do Kakegurui
        this.images = [
            "https://i.ibb.co/xKb6yhHs/K-1.jpg",
            "https://i.ibb.co/B2wKW8bZ/K-2.jpg",
            "https://i.ibb.co/FLgFmkhV/K-3.jpg",
            "https://i.ibb.co/3H7WX2S/K-4.jpg",
            "https://i.ibb.co/jPTVHf5z/K-5.jpg",
            "https://i.ibb.co/KcMtz0Rb/K-6.jpg",
            "https://i.ibb.co/F4JppfFv/K-7.jpg",
            "https://i.ibb.co/YBzJydhk/K-8.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando KakeguruiGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando KakeguruiGallery...');
        ...
        console.log('KakeguruiGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Kakegurui - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🎰 Olá! Quero esta placa do Kakegurui (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO KAKEGURUI
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('kakegurui.html')) {
        console.log('Página de gallery Kakegurui detectada - inicializando...');
        const kakeguruiGallery = new KakeguruiGallery();
    }
});
