/**
 * SISTEMA DEATH NOTE GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Death Note
 */
class DeathNoteGallery {
    constructor() {
        // Lista de imagens do Death Note
        this.images = [
            "https://i.ibb.co/VYk2YbSz/DN-1.jpg",
            "https://i.ibb.co/9C4ZC1h/DN-2.jpg",
            "https://i.ibb.co/0jGYr9dP/DN-3.jpg",
            "https://i.ibb.co/5WFvV99F/DN-4.jpg",
            "https://i.ibb.co/21tvtK9y/DN-5.jpg",
            "https://i.ibb.co/PHwZg6M/DN-6.jpg",
            "https://i.ibb.co/ycCbPMNm/DN-7.jpg",
            "https://i.ibb.co/DfV8BQ1m/DN-8.jpg",
            "https://i.ibb.co/RTV4Mt25/DN-9.jpg",
            "https://i.ibb.co/PGxLzsvK/DN-10.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando DeathNoteGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando DeathNoteGallery...');
        ...
        console.log('DeathNoteGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Death Note - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `📓 Olá! Quero esta placa do Death Note (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO DEATH NOTE
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('deathnote.html')) {
        console.log('Página de gallery Death Note detectada - inicializando...');
        const deathNoteGallery = new DeathNoteGallery();
    }
});
