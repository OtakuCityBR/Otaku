/**
 * SISTEMA VIOLET EVERGARDEN GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Violet Evergarden
 */
class VioletEvergardenGallery {
    constructor() {
        // Lista de imagens do Violet Evergarden
        this.images = [
            "https://i.ibb.co/JjLxmZLK/v-1.jpg",
            "https://i.ibb.co/rLQQFF7/v-2.jpg",
            "https://i.ibb.co/ch35PQnF/v-3.jpg",
            "https://i.ibb.co/JWYnfGm4/v-4.jpg",
            "https://i.ibb.co/5hTDq2XV/v-5.jpg",
            "https://i.ibb.co/jvxYTCRf/v-6.jpg",
            "https://i.ibb.co/yF3DxB4y/v-8.jpg",
            "https://i.ibb.co/rfsT1ZDh/v-9.jpg",
            "https://i.ibb.co/mCtkKTvC/v-10.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando VioletEvergardenGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando VioletEvergardenGallery...');
        ...
        console.log('VioletEvergardenGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Violet Evergarden - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `💌 Olá! Quero esta placa do Violet Evergarden (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO VIOLET EVERGARDEN
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('violetevergarden.html')) {
        console.log('Página de gallery Violet Evergarden detectada - inicializando...');
        const violetevergardenGallery = new VioletEvergardenGallery();
    }
});
