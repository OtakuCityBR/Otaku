/**
 * SISTEMA LABUBU GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o Labubu
 */
class LabubuGallery {
    constructor() {
        // Lista de imagens do Labubu
        this.images = [
            "https://i.ibb.co/3ydbnhdG/L-16.jpg",
            "https://i.ibb.co/x8hScp0D/L-17.jpg",
            "https://i.ibb.co/0yhx3LQQ/L-18.jpg",
            "https://i.ibb.co/WpyF8RtD/L-19.jpg",
            "https://i.ibb.co/8nR8VN7j/L-20.jpg",
            "https://i.ibb.co/vCvJQxp3/L-21.jpg",
            "https://i.ibb.co/zTVQyjPw/L-22.jpg",
            "https://i.ibb.co/DHh7wyyT/L-23.jpg",
            "https://i.ibb.co/rGkhSH8z/L-1.jpg",
            "https://i.ibb.co/j9975DCM/L-2.jpg",
            "https://i.ibb.co/Q3znhJHd/L-3.jpg",
            "https://i.ibb.co/4gsMXnr2/L-4.jpg",
            "https://i.ibb.co/4n2MxgtH/L-5.jpg",
            "https://i.ibb.co/ymvc07q6/L-6.jpg",
            "https://i.ibb.co/k21f8B4q/L-7.jpg",
            "https://i.ibb.co/MDTdWY4w/L-8.jpg",
            "https://i.ibb.co/PsgLPkPK/L-9.jpg",
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando LabubuGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando LabubuGallery...');
        ...
        console.log('LabubuGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Labubu - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🧸 Olá! Quero esta placa do Labubu (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO LABUBU
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('labubu.html')) {
        console.log('Página de gallery Labubu detectada - inicializando...');
        const labubuGallery = new LabubuGallery();
    }
});
