/**
 * SISTEMA MOB PSYCHO 100 GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Mob Psycho 100
 */
class MobPsycho100Gallery {
    constructor() {
        // Lista de imagens do Mob Psycho 100
        this.images = [
            "https://i.ibb.co/TDcF5hnt/m1.jpg",
            "https://i.ibb.co/CKY02zmJ/m2.jpg",
            "https://i.ibb.co/h1hggZMp/m3.jpg",
            "https://i.ibb.co/0RC2chQf/m4.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando MobPsycho100Gallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando MobPsycho100Gallery...');
        ...
        console.log('MobPsycho100Gallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Mob Psycho 100 - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🧠 Olá! Quero esta placa do Mob Psycho 100 (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO MOB PSYCHO 100
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('mobpsycho100.html')) {
        console.log('Página de gallery Mob Psycho 100 detectada - inicializando...');
        const mobPsycho100Gallery = new MobPsycho100Gallery();
    }
});
