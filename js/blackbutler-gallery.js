/**
 * SISTEMA BLACK BUTLER GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Black Butler
 */
class BlackButlerGallery {
    constructor() {
        // Lista de imagens do Black Butler
        this.images = [
            "https://i.ibb.co/21mwy04q/b-1.jpg",
            "https://i.ibb.co/fYzKjsgh/b-2.jpg",
            "https://i.ibb.co/XfwrMFRy/b-3.jpg",
            "https://i.ibb.co/Rk37HzYZ/b-4.jpg",
            "https://i.ibb.co/N2qpCzHb/b-5.jpg",
            "https://i.ibb.co/fzbmWYBf/b-6.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando BlackButlerGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando BlackButlerGallery...');
        ...
        console.log('BlackButlerGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Black Butler - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🖤 Olá! Quero esta placa do Black Butler (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO BLACK BUTLER
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('blackbutler.html')) {
        console.log('Página de gallery Black Butler detectada - inicializando...');
        const blackbutlerGallery = new BlackButlerGallery();
    }
});
