/**
 * SISTEMA DOROHEDORO GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Dorohedoro
 */
class DorohedoroGallery {
    constructor() {
        // Lista de imagens do Dorohedoro
        this.images = [
            "https://i.ibb.co/bRFf7Md1/DHD-1.jpg",
            "https://i.ibb.co/v6PppffS/DHD-2.jpg",
            "https://i.ibb.co/Kx5y5N1J/DHD-3.jpg",
            "https://i.ibb.co/JW57s3Hg/DHD-4.jpg",
            "https://i.ibb.co/F4jDgQ6F/DHD-5.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando DorohedoroGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando DorohedoroGallery...');
        ...
        console.log('DorohedoroGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Dorohedoro - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🦎 Olá! Quero esta placa do Dorohedoro (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO DOROHEDORO
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('dorohedoro.html')) {
        console.log('Página de gallery Dorohedoro detectada - inicializando...');
        const dorohedoroGallery = new DorohedoroGallery();
    }
});
