/**
 * SISTEMA RECORD OF RAGNAROK GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Record of Ragnarok
 */
class RecordOfRagnarokGallery {
    constructor() {
        // Lista de imagens do Record of Ragnarok
        this.images = [
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando RecordOfRagnarokGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando RecordOfRagnarokGallery...');
        ...
        console.log('RecordOfRagnarokGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Record of Ragnarok - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⚡ Olá! Quero esta placa do Record of Ragnarok (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO RECORD OF RAGNAROK
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('recordofragnarok.html')) {
        console.log('Página de gallery Record of Ragnarok detectada - inicializando...');
        const recordofragnarokGallery = new RecordOfRagnarokGallery();
    }
});
