/**
 * SISTEMA YOUR NAME GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o filme Your Name
 */
class YourNameGallery {
    constructor() {
        // Lista de imagens do Your Name
        this.images = [
            "https://i.ibb.co/8gmQQyRJ/yn-3.jpg",
            "https://i.ibb.co/bRy6BFB0/yn-4.jpg",
            "https://i.ibb.co/27zzJLTp/yn-5.jpg",
            "https://i.ibb.co/nM5r9h3D/yn-1.jpg",
            "https://i.ibb.co/tPhgB02h/yn-2.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando YourNameGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando YourNameGallery...');
        ...
        console.log('YourNameGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Your Name - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⭐ Olá! Quero esta placa do Your Name (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO YOUR NAME
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('yourname.html')) {
        console.log('Página de gallery Your Name detectada - inicializando...');
        const yournameGallery = new YourNameGallery();
    }
});
