/**
 * SISTEMA ONE PUNCH MAN GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime One Punch Man
 */
class OnePunchManGallery {
    constructor() {
        ...
        this.images = [
            ...
            "https://i.ibb.co/JWtJzM3c/4.jpg",
            "https://i.ibb.co/mjLPBQH/5.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando OnePunchManGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando OnePunchManGallery...');
        ...
        console.log('OnePunchManGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `One Punch Man - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `👊 Olá! Quero esta placa do One Punch Man (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO ONE PUNCH MAN
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('onepunchman.html')) {
        console.log('Página de gallery One Punch Man detectada - inicializando...');
        const onePunchManGallery = new OnePunchManGallery();
    }
});
