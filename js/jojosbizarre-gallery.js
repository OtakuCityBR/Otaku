/**
 * SISTEMA JOJO'S BIZARRE ADVENTURE GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime JoJo's Bizarre Adventure
 */
class JojosBizarreGallery {
    constructor() {
        // Lista de imagens do JoJo's Bizarre Adventure
        this.images = [
            "https://i.ibb.co/LzJCgDHh/j-1.jpg",
            "https://i.ibb.co/Z6jLr8mp/j-2.jpg",
            "https://i.ibb.co/B29QJpxZ/j-3.jpg",
            "https://i.ibb.co/0jq5mQ6F/j-4.jpg",
            "https://i.ibb.co/67sdBKVL/j-5.jpg",
            "https://i.ibb.co/xqHrtMNd/j-6.jpg",
            "https://i.ibb.co/rR2LjwM5/j-7.jpg",
            "https://i.ibb.co/GQkyTCNF/j-8.jpg",
            "https://i.ibb.co/MxbwsnR6/j-9.jpg",
            "https://i.ibb.co/4RgtLB4Z/j-10.jpg",
            "https://i.ibb.co/b5HgBr6d/j-11.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando JojosBizarreGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando JojosBizarreGallery...');
        ...
        console.log('JojosBizarreGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `JoJo's Bizarre Adventure - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `⭐ Olá! Quero esta placa do JoJo's Bizarre Adventure (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO JOJO'S BIZARRE ADVENTURE
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('jojosbizarre.html')) {
        console.log('Página de gallery JoJo\'s Bizarre Adventure detectada - inicializando...');
        const jojosBizarreGallery = new JojosBizarreGallery();
    }
});
