/**
 * SISTEMA HAIKYUU GALLERY - MOSTRUÁRIO DE IMAGENS
 * 
 * Baseado no template das páginas One Piece e Naruto
 * Adaptado especificamente para o anime Haikyuu
 */
class HaikyuuGallery {
    constructor() {
        ...
        this.images = [
            ...
            "https://i.ibb.co/cKcjRMJM/Ha-5.jpg",
            "https://i.ibb.co/HvWN1zL/Ha-6.jpg",
            "https://i.ibb.co/Q3jQ55CK/Ha-7.jpg",
            "https://i.ibb.co/DPysy6P2/Ha-8.jpg",
            "https://i.ibb.co/hb9znwr/Ha-9.jpg",
            "https://i.ibb.co/5bR4dfQ/Ha-10.jpg",
            "https://i.ibb.co/VYZpSXyn/Ha-11.jpg"
        ];
        ...
        if (!this.galleryGrid) {
            console.log('Grid da gallery não encontrado - não inicializando HaikyuuGallery');
            return;
        }
     ...
     */
    init() {
        console.log('Inicializando HaikyuuGallery...');
        ...
        console.log('HaikyuuGallery inicializada com sucesso!');
    }
    ...
    createGalleryItems() {
        this.images.forEach((imgSrc, index) => {
            ...
            img.src = imgSrc;
            img.loading = "lazy";
            img.alt = `Haikyuu - Placa decorativa ${index + 1}`;
    ...
    sendWhatsAppMessage(imageUrl, imageNumber) {
        const message = `🏐 Olá! Quero esta placa do Haikyuu (#${imageNumber}): ${imageUrl}`;
...
/**
 * INICIALIZAÇÃO AUTOMÁTICA DO HAIKYUU
 */
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('galleryGrid') && window.location.pathname.includes('haikyuu.html')) {
        console.log('Página de gallery Haikyuu detectada - inicializando...');
        const haikyuuGallery = new HaikyuuGallery();
    }
});
